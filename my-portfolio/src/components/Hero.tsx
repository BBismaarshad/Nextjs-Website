        ...
        <div className=" flex justify-center flex-col w-[80%] h-[100%] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[3rem] items-center">
            <div>
              ...
              <p className="mt-[ 1.2rem]  text-[13px] md:text-[15px] text-white">
